    ...
    <div className="hidden md:flex flex-col w-64 bg-black p-6 gap-y-6">
      ...
      <div className="mt-auto pt-6 border-t border-spotify-light">
        <div className="flex flex-col gap-y-4">
          <a href="#" className="text-xs text-spotify-text hover:text-white transition">
            Cookies
          </a>
          <a href="#" className="text-xs text-spotify-text hover:text-white transition">
            Privacy Policy
